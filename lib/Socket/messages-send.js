...
export const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // --- INICIO CORRECCIÓN EXPLOIT FAKEMSG ---
            // Baileys ESM es estricto y rechaza llaves de edición a medias (como edit: { id: tempId }).
            // Si el cliente de WA ve un edit sin 'fromMe: true', bloquea la colisión y crea una burbuja nueva (como pasaba con Furina).
            // Aquí autocompletamos la llave tal cual lo hacía CJS para que la edición pase sin filtros.
            if (content && content.edit && typeof content.edit === 'object') {
                if (content.edit.fromMe === undefined) content.edit.fromMe = true;
                if (content.edit.remoteJid === undefined) content.edit.remoteJid = jid;
            }
            // --- FIN CORRECCIÓN EXPLOIT FAKEMSG ---
            ...
            if (Array.isArray(jid)) {
                ...
                if (isDeleteMsg || isKeepMsg) {
                    ...
                    // SE RESTAURA EL ATRIBUTO EDIT='1' PARA QUE WHATSAPP LEA LA EDICIÓN CORRECTAMENTE
